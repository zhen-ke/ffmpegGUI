...
const commandTemplates = [
  ...
  },
  {
    ...
    command: '-c:v libx265 -preset medium -crf 28 -c:a aac -b:a 128k',
    description: {
  ...
  },
  {
    ...
    command: '-vf "scale=-1:720" -c:v libx264 -crf 23 -c:a copy',
    description: {
  ...
  },
  {
    ...
    command: '-ss 00:00:10 -t 00:00:30 -c copy',
    description: {
  ...
  },
  {
    ...
    command: '-vf "fps=10,scale=320:-1:flags=lanczos" -c:v gif',
    description: {
  ...
  },
  {
    ...
    command:
      '-vf "fps=15,scale=480:-1:flags=lanczos,split[s0][s1];[s0]palettegen=stats_mode=diff[p];[s1][p]paletteuse=dither=bayer:bayer_scale=5:diff_mode=rectangle"',
    description: {
  ...
  },
  {
    ...
    command: '-i subtitles.srt -c copy -c:s mov_text',
    description: {
  ...
  },
  {
    ...
    command:
      '-vf "scale=iw*0.5:ih*0.5" -c:v libx264 -crf 28 -preset slower -c:a aac -b:a 96k',
    description: {
  ...
  },
  {
    ...
    command:
      '-c:v libx264 -tag:v avc1 -movflags faststart -crf 30 -preset superfast -c:a aac -b:a 128k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v libvpx-vp9 -crf 30 -b:v 0 -b:a 128k -c:a libopus',
    description: {
  ...
  },
  {
    ...
    command: '-c:v h264_qsv -preset slow -qp 23 -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v h264_amf -quality quality -qp_i 23 -qp_p 25 -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v h264_nvenc -preset slow -cq 23 -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v h264_videotoolbox -q:v 65 -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v libx265 -crf 28 -preset medium -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v hevc_qsv -preset slow -global_quality 23 -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v hevc_amf -quality quality -qp_i 23 -qp_p 25 -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v hevc_nvenc -preset slow -cq 23 -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v hevc_videotoolbox -q:v 65 -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v libx264 -b:v 6000k -maxrate 6600k -bufsize 8000k -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command:
      '-c:v libx264 -b:v 2000k -maxrate 2200k -bufsize 3000k -pass 2 -preset slow -b:a 256k',
    description: {
  ...
  },
  {
    ...
    command: '-c:v copy -c:a aac -b:a 256k',
    description: {
  ...
  {
    name: {
      en: 'Convert to MP3 Format',
      zh: '转换为 MP3 格式',
    },
    command: '-vn -c:a libmp3lame -b:a 256k',
    description: {
      en: 'Extract audio and convert it to MP3 format with 256k bitrate.',
      zh: '提取音频并转换为比特率为 256k 的 MP3 格式。',
    },
  },
  {
    name: {
    ...
    command:
      '-filter_complex "[0:v] scale=480:-1:flags=lanczos,fps=15,split [a][b];[a] palettegen=stats_mode=single [p];[b][p] paletteuse=new=1"',
    description: {
      en: 'Create a GIF with 15 frames per second and 480p resolution.',
      zh: '创建帧率为 15fps，分辨率为 480p 的 GIF。',
    },
  },
  {
    name: {
    ...
    command:
      '-vf "split [main][tmp]; [tmp] crop=w:h:x:y,boxblur=luma_radius=25:luma_power=2:enable=\'between(t,start_time,end_time)\'[tmp]; [main][tmp] overlay=x:y"',
    description: {
      en: 'Apply blur effect to a specific area of the video. Replace w, h, x, y, start_time, end_time with actual values.',
      zh: '对视频的特定区域应用模糊效果。使用时请替换 w, h, x, y, start_time, end_time 为实际值。',
    },
  },
  {
    name: {
    ...
    command:
      '-filter_complex "[0:v]setpts=0.5*PTS[v];[0:a]atempo=2[a]" -map "[v]" -map "[a]"',
    description: {
  ...
  },
  {
    ...
    command:
      '-filter_complex "[0:v]setpts=2*PTS,minterpolate=\'mi_mode=mci:mc_mode=aobmc:vsbmc=1:fps=60\'[v];[0:a]atempo=0.5[a]" -map "[v]" -map "[a]"',
    description: {
  ...
  },
  {
    ...
    command:
      '-filter_complex "[0:v]minterpolate=\'mi_mode=mci:mc_mode=aobmc:vsbmc=1:fps=60\'"',
    description: {
  ...
  },
  {
    ...
    command: '-itsoffset 1 -i input.mp4 -c copy -map 0:v -map 1:a',
    description: {
  ...
  },
  {
    ...
    command:
      '-loop 1 -i image.jpg -i audio.mp3 -c:v libx264 -tune stillimage -c:a aac -shortest',
    description: {
  ...
  },
  {
    ...
    command:
      '-i input.mp4 -i cover.jpg -map 0 -map 1 -c copy -c:v:1 png -disposition:v:1 attached_pic',
    description: {
  ...
  },
  {
    ...
    command: '-filter:a loudnorm=I=-23:LRA=7:TP=-2',
    description: {
  ...
  },
  {
    ...
    command: '-af "pan=stereo|c0=c0|c1=0*c1"',
    description: {
  ...
  },
  {
    ...
    command: '-af "pan=stereo|c0=c1|c1=c0"',
    description: {
  ...
  },
  {
    ...
    command:
      '-filter_complex "[0:a][1:a]amerge=inputs=2[a]" -map 0:v -map "[a]" -c:v copy',
    description: {
